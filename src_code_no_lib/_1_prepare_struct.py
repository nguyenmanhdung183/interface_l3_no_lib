...
DEC_TEMPLATE_PATH = os.path.join(TEMPLATES_DIR, "dec_template.txt")
EN_TEMPLATE_PATH = os.path.join(TEMPLATES_DIR, "en_template.txt")
GET_DATA_TEMPLATE_PATH = os.path.join(TEMPLATES_DIR, "get_data_template.txt")
HEADER_TEMPLATE_PATH = os.path.join(TEMPLATES_DIR, "header_template.txt")
HEADER_PARSER_TEMPLATE_PATH = os.path.join(TEMPLATES_DIR, "header_parser_template.txt")

RESULT_FOLDER = os.path.join(BASE_DIR, "..", "1.RESULTS_NO_LIB")
